...
function bool = A18(vZ, vT, trace)
	...
	if(checkColumns(cpd00020_c0_,cpd00061_c0_,cpd00482_c0_) == 0)
		bool = -1;
	elseif((-1)*vT(cpd00020_c0_) + (-1)*vT(cpd00061_c0_) + (-1)*vT(cpd00482_c0_) <= (-1)*vZ(cpd00020_c0_) + (-1)*vZ(cpd00061_c0_) + (-1)*vZ(cpd00482_c0_))
		bool = 1;
	else
		bool = 0;
	end
